...
This tutorial provides general video/audio programming knowledge, SDK concepts, and in-page programming modules to help you achieve the following objectives:
- Understanding Agora solution for video chat.
- Understanding the API design of Agora RTC Web SDK.
- Integrating the Agora RTC Web SDK in your web project to implement a simple video chat app. 
...
- Encoding/Decoding and transmission: Encodes the video/audio signals and transmits the encoded signals to other devices. When a device receives the signals, it decodes the signal to get video/audio signals and renders the signals.
